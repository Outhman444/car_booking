                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-3">
                            <a
                                ...
                                :href="`/client/payment/${reservation.id}`"
                                class="block w-full rounded-lg bg-orange-500 px-6 py-3 text-center font-bold text-white transition-colors duration-200 hover:bg-orange-600 animate-pulse"
                            >
                                Proceed to Payment
                            </a>
                            <a
