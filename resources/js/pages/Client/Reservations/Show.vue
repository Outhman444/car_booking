    ...
    <main class="flex-1 p-8 space-y-6">
      <div class="flex items-center justify-between gap-4">
        ...
        <div class="flex gap-2">
          ...
          <a :href="`/client/reservations/${reservation.id}/print`" target="_blank" rel="noopener">
            <Button variant="secondary">Print</Button>
          </a>
          <Link v-if="!hasPayment && (reservation.status === 'pending' || reservation.status === 'confirmed')" :href="`/client/payment/${reservation.id}`">
            <Button>
