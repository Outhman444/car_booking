                    ...
                    <div class="lg:w-1/4">
                        ...
                        >
                            ...
                            <div class="space-y-3 pt-4 border-t border-gray-200">
                                <label class="block text-sm font-medium text-gray-700">Availability Period</label>
                                <div class="grid grid-cols-1 gap-2">
                                    <input
                                        v-model="startDate"
                                        type="date"
                                        class="w-full rounded-xl border border-gray-300 px-4 py-2 text-sm transition-all focus:border-orange-500 focus:ring-4 focus:ring-orange-100"
                                        placeholder="Pick-up"
                                    />
                                    <input
                                        v-model="endDate"
                                ...
                                <button
                                    @click="applyFilters"
                                    class="w-full rounded-xl border border-orange-200 bg-orange-50 py-2 text-sm font-semibold text-orange-600 transition-colors hover:bg-orange-100"
                                >
                                    Check Availability
                                </button>
                            </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-3">
                                            <div class="relative">
                                                <span
                                                    ...
                                                    >{{ $page.props.currency.symbol }}</span
                                                >
                                                <input
                                                    v-model="minPrice"
                                                    type="number"
